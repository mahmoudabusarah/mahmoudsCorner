...
<body class="main-layout ">
   ...
   <div class="container">
  <h2>unsloved tickets</h2>
  <p>here you can find the unsloved Tickets :</p>            
  <table class="table table-hover">
    ...
    <tbody>
        ...
        <?php
          ...
          ?>
           ...
           <td><?php echo $row['Order_Device_name']?></td>
           <td><?php echo $row['Order_total']?></td>
           <td><?php echo $row['User_name']?></td>
           <td><?php echo $row['User_email']?></td>
           <td><?php echo $row['shipping_adress']?></td>
           <td><?php echo $row['User_problem']?></td>
     
          <?php  }
            } else {
            echo "No un solved Tickets";
            }
        ...
        ?>
                                ...
                                <form method="post" action="D_E_unsolvedtickets.php">
                                   <input class="send" name="lgn3" value="Download on excel" type="submit">
                                   </form>
</div>
    <!-- end contact -->
    ...
    <div class="container">
  <h2>sloved tickets</h2>
  <p>here you can find the sloved Tickets :</p>            
  <table class="table table-hover">
    <thead>
      <tr>
        <th>Ticket ID</th>
    ...
    <tbody>
        ...
        <?php
            ...
            $sql2 = "SELECT * FROM `tickiting_report` WHERE `ticket_status`= 'solved'";
          ...
          ?>
           ...
           <td><?php echo $row2['Order_name']?></td>
           <td><?php echo $row2['Order_Device_name']?></td>
           <td><?php echo $row2['Order_total']?></td>
           <td><?php echo $row2['User_name']?></td>
           <td><?php echo $row2['User_email']?></td>
           <td><?php echo $row2['shipping_adress']?></td>
           <td><?php echo $row2['User_problem']?></td>
     
          <?php  }
            } else {
            echo "No solved Tickets";
            }
        ...
        ?>
                                 ...
                                 <form method="post" action="D_E_solvedtickets.php">
                                   <input class="send" name="lgn2" value="Download on excel" type="submit">
                                   </form>
</div>
    <!-- Javascript files-->
