...
<body class="main-layout ">
                ...
                <div class="col-md-12">
                    ...
                    <form class="main_form" method="post" >
                        <div class="row">
                            ...
                            <input type="text" class="form-control" id="usr" placeholder="enter support name " name="pn">
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                            <input type="text" class="form-control" id="usr" placeholder="enter support Email " name="pp">
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                            <input type="passwrod" class="form-control" id="usr" placeholder="enter support password " name="ps">
                            </div>
                            <div class=" col-md-12">
                                <input class="send" name="adp" value="add support agent" type="submit">
                            </div>
                        </div>
                    </form>
    ...
    <!-- end contact -->
        ...
        if(isset($_POST["adp"])){
            ...
            $sql = "INSERT INTO `support_table`(`Support_Name`, `Support_Email`, `Support_Password`)
             VALUES ('$pn','$pp','$ps')";

            if ($conn->query($sql) === TRUE) {
                echo "Support add sucessfully ";
            } else {
