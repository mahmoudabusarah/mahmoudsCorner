                            ...
                            <div class="limit-box">
                                <nav class="main-menu">
                                    <ul class="menu-area-main">
                                        ...
                                        <li><a href="Reviewticktes.php?id=<?php echo$ID ?>">Review ticktes</a></li>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <form class="main_form" method="post" enctype="multipart/form-data" action="addinp.php">
                        <div class="row">
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                            <input type="text" class="form-control" id="usr" placeholder="enter product name " name="pn">
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                            <input type="text" class="form-control" id="usr" placeholder="enter product price " name="pp">
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                            <input type="text" class="form-control" id="usr" name="pb" placeholder="enter product brand">
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                            <input type="file" name="fileToUpload" id="fileToUpload">
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                            <input type="text" class="form-control" id="usr" name="py" placeholder="enter product year">
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                            <input type="text" class="form-control" id="usr" name="pc" placeholder="enter product color">
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                            <input type="text" class="form-control" id="usr" name="pr" placeholder="product rating">
                            </div>
                            
                            <div class=" col-md-12">
                                <input class="send" name="adp" value="add product" type="submit">
                            </div>
                        </div>
                    </form>
